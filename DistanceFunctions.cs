...
public static class DistanceFunctions<T> where T : struct
{
    ...
    /// <returns></returns>
    /// <exception cref="ArgumentException">Thrown if the dimensions of the points differ.</exception>
    public static double Minkowski(double[] point1, double[] point2, double p)
    {
        if (point1.Length != point2.Length)
        {
            throw new ArgumentException("Data points must have the same number of dimensions.");
    ...
    /// <returns></returns>
    /// <exception cref="ArgumentException">Thrown if the dimensions of the points differ.</exception>
    public static double ChebshevDistance(double[] point1, double[] point2)
    {
        if (point1.Length != point2.Length)
        {
            throw new ArgumentException("Data points must have the same number of dimensions.");
